...
const buildNotesPrompt = ({ material, access, sourceMode }) => {
  ...
  return [
    'You are refining detailed study notes for ReimuruABT.',
...
const buildExamPrompt = ({ material, access, examStyle, sourceMode }) => {
  ...
  return [
    'You are building a formatted practice exam pack for ReimuruABT.',
    'Return ONLY valid JSON using this exact shape:',
...
app.listen(PORT, () => {
  console.log(`ReimuruABT V3 running on port ${PORT}`);
});
